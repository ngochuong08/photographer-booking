                            ...
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  ...
                                  src="theme/admin/assets/img/doctors/doctor-thumb-01.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-02.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-03.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-04.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-05.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-06.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-07.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-08.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-09.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 class="table-avatar">
                              ...
                              >
                                <img
                                  class="avatar-img rounded-circle"
                                  src="theme/admin/assets/img/doctors/doctor-thumb-10.jpg"
                                  alt="User Image"
                                />
                              </a>
