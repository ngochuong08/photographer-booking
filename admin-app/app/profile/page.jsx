              ...
              <div className="profile-header">
                <div className="row align-items-center">
                  <div className="col-auto profile-image">
                    <a href="#">
                      <img className="rounded-circle" alt="User Image" src="/theme/admin/assets/img/profiles/avatar-01.jpg" />
                    </a>
                  </div>
                  <div className="col ml-md-n2 profile-user-info">
                    <h4 className="user-name mb-0">Ryan Taylor</h4>
                    <h6 className="text-muted">[email protected]</h6>
                      ...
                      <div className="card">
                        <div className="card-body">
                          ...
                          <div className="row">
                            ...
                            <p className="col-sm-10 mb-0">4663 Agriculture Lane,<br />Miami,<br />Florida - 33165,<br />United States.</p>
                          </div>
                        </div>
                      </div>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-12 col-sm-6">
                                    <div className="mb-3">
                                      ...
                                      <input type="text" className="form-control" defaultValue="+1 202-555-0125" />
                                    </div>
                                  </div>
                                  <div className="col-12">
