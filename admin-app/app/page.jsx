                          ...
                          <td>
                            <h2 className="table-avatar">
                              ...
                              >
                                <img
                                  className="avatar-img rounded-circle"
                                  src="/theme/admin/assets/img/patients/patient1.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 className="table-avatar">
                              ...
                              >
                                <img
                                  className="avatar-img rounded-circle"
                                  src="/theme/admin/assets/img/patients/patient2.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 className="table-avatar">
                              ...
                              >
                                <img
                                  className="avatar-img rounded-circle"
                                  src="/theme/admin/assets/img/patients/patient3.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 className="table-avatar">
                              ...
                              >
                                <img
                                  className="avatar-img rounded-circle"
                                  src="/theme/admin/assets/img/patients/patient4.jpg"
                                  alt="User Image"
                                />
                              </a>
                          ...
                          <td>
                            <h2 className="table-avatar">
                              ...
                              >
                                <img
                                  className="avatar-img rounded-circle"
                                  src="/theme/admin/assets/img/patients/patient5.jpg"
                                  alt="User Image"
                                />
                              </a>
