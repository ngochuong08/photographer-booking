      ...
      <div className="sidebar-inner slimscroll">
        <div id="sidebar-menu" className="sidebar-menu">
          <ul>
            ...
            <li><a href="./gallery"><i className="fe fe-vector"></i> <span>Galleries</span></a></li>
            <li><a href="./transactions-list"><i className="fe fe-activity"></i> <span>Transactions</span></a></li>
            <li><a href="./reviews"><i className="fe fe-star-o"></i> <span>Reviews</span></a></li>
