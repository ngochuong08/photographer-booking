          ...
          <div class="row">
            <div class="col-lg-10 mx-auto">
              <div class="booking-wizard">
                <ul
                  class="form-wizard-steps d-sm-flex align-items-center justify-content-center"
                  id="progressbar2"
                >
                          ...
                          <div class="card-body">
                            <div class="d-flex align-items-center flex-wrap rpw-gap-2 flex-wrap row-gap-2">
                              ...
                              <div>
                                ...
                                <p class="mb-0">
                                  <i class="isax isax-location me-2"></i>5th
                                  Street - 1011 W 5th St, Suite 120, Austin, TX
                                  78703
                                </p>
                              </div>
                            </div>
                                ...
                                >
                                  <span class="d-flex align-items-center flex-wrap rpw-gap-2">
                                    ...
                                    <span>
                                      ...
                                      <span class="fs-14">
                                        418 Patton Lane, Garner, NC 27529, FL
                                        33169
                                      </span>
                                      <i class="fa-solid fa-circle fs-5 text-primary mx-2 me-1"></i>
                            ...
                            <div class="card-body">
                              ...
                              <div class="pt-3 border-top booking-more-info">
                                ...
                                <div class="d-flex align-items-center flex-wrap rpw-gap-2 justify-content-between mb-2">
                                  ...
                                  <span class="fw-medium text-danger d-block">
                                    -$15
                                  </span>
                                </div>
                              </div>
                            ...
                            <div class="card ">
                              ...
                              <div class="card-header d-flex align-items-center flex-wrap rpw-gap-2">
                                ...
                                <p class="mb-0">
                                  ...
                                  be on time before{" "}
                                  <span class="text-dark">15 Mins </span> From
                              ...
                              <div class="card-body pb-1">
                                <div class="d-flex align-items-center flex-wrap rpw-gap-2 justify-content-between mb-3">
                                  ...
                                  >
                                    <i class="isax isax-calendar me-1"></i>
                                    Reschedule
                                  </a>
                                </div>
                                <div class="row">
                          ...
                          <div class="card flex-fill">
                            <div class="card-body d-flex flex-column justify-content-between">
                              <div class="text-center">
                                ...
                                <span class="booking-id-badge mb-3">
                                  DCRA12565
                                </span>
